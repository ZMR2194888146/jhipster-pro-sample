  ...
  public save(): void {
    ...
    if (this.department.id) {
      this.departmentService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.settingsDepartment.updated', { param: param.id }).toString();
      ...
      this.departmentService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.settingsDepartment.created', { param: param.id }).toString();
