<template>
  <a-card :body-style="{ padding: '24px 32px' }" :bordered="false">
    <a-form layout="inline" @submit.prevent="save" class="ant-advanced-update-form">
      <a-row :gutter="24">
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.id')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input placeholder="input placeholder" v-model="$v.department.id.$model" id="department-id" name="id" read-only />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.name')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input placeholder="input placeholder" v-model="$v.department.name.$model" id="department-name" name="name" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.code')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input placeholder="input placeholder" v-model="$v.department.code.$model" id="department-code" name="code" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.address')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input placeholder="input placeholder" v-model="$v.department.address.$model" id="department-address" name="address" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.phoneNum')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input placeholder="input placeholder" v-model="$v.department.phoneNum.$model" id="department-phoneNum" name="phoneNum" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.logo')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input placeholder="input placeholder" v-model="$v.department.logo.$model" id="department-logo" name="logo" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.contact')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input placeholder="input placeholder" v-model="$v.department.contact.$model" id="department-contact" name="contact" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.createUserId')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input
        ...
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.createTime')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-date-picker id="department-createTime" name="createTime" show-time v-model="$v.department.createTime.$model">
            </a-date-picker>
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.authorities')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-tree-select
              allowClear
        ...
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartment.parent')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
