  ...
  public save(): void {
    ...
    if (this.dataDictionary.id) {
      this.dataDictionaryService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.settingsDataDictionary.updated', { param: param.id }).toString();
      ...
      this.dataDictionaryService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.settingsDataDictionary.created', { param: param.id }).toString();
