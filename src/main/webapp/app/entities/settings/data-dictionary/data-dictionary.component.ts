...
export default class DataDictionaryComponent extends Vue {
  ...
  public clickDataDictionaryId = null;
  public searchValue = '';
  ...
  public removeById(removeId: number): void {
    this.dataDictionaryService()
      ...
      .then((res: AxiosResponse) => {
        const message = this.$t('lwjsApp.settingsDataDictionary.deleted', { param: this.removeId }).toString();
  ...
  public initRelationships(): void {
    this.loading = true;
    Promise.all([this.dataDictionaryService().tree()])
  ...
  private generateColumns() {
    ...
    this.xGridColumns.push({
      ...
      editRender: {
        ...
        options: this.relationshipsData['dataDictionaries'],
