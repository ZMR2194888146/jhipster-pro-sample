  ...
  public save(): void {
    ...
    if (this.departmentAuthority.id) {
      this.departmentAuthorityService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.settingsDepartmentAuthority.updated', { param: param.id }).toString();
      ...
      this.departmentAuthorityService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.settingsDepartmentAuthority.created', { param: param.id }).toString();
