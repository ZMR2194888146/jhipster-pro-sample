<template>
  <a-card :body-style="{ padding: '24px 32px' }" :bordered="false">
    <a-form layout="inline" @submit.prevent="save" class="ant-advanced-update-form">
      <a-row :gutter="24">
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartmentAuthority.id')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input
        ...
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartmentAuthority.name')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input
              placeholder="input placeholder"
        ...
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartmentAuthority.code')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input
              placeholder="input placeholder"
        ...
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartmentAuthority.description')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input
              placeholder="input placeholder"
        ...
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartmentAuthority.createUserId')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-input
              placeholder="input placeholder"
        ...
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartmentAuthority.createTime')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
            <a-date-picker
        ...
        <a-col :span="8">
          <a-form-item :label="$t('lwjsApp.settingsDepartmentAuthority.department')" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
