  ...
  public save(): void {
    ...
    if (this.position.id) {
      this.positionService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.settingsPosition.updated', { param: param.id }).toString();
      ...
      this.positionService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.settingsPosition.created', { param: param.id }).toString();
