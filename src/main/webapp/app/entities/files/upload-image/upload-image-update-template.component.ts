  ...
  public save(): void {
    ...
    if (this.uploadImage.id) {
      this.uploadImageService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.filesUploadImage.updated', { param: param.id }).toString();
      ...
      this.uploadImageService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.filesUploadImage.created', { param: param.id }).toString();
