  ...
  public save(): void {
    ...
    if (this.ossConfig.id) {
      this.ossConfigService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.filesOssConfig.updated', { param: param.id }).toString();
      ...
      this.ossConfigService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.filesOssConfig.created', { param: param.id }).toString();
