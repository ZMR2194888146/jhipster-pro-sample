  ...
  public save(): void {
    ...
    if (this.resourceCategory.id) {
      this.resourceCategoryService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.filesResourceCategory.updated', { param: param.id }).toString();
      ...
      this.resourceCategoryService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.filesResourceCategory.created', { param: param.id }).toString();
