  ...
  public save(): void {
    ...
    if (this.apiPermission.id) {
      this.apiPermissionService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.systemApiPermission.updated', { param: param.id }).toString();
      ...
      this.apiPermissionService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.systemApiPermission.created', { param: param.id }).toString();
