  ...
  public save(): void {
    ...
    if (this.authority.id) {
      this.authorityService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.systemAuthority.updated', { param: param.id }).toString();
      ...
      this.authorityService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.systemAuthority.created', { param: param.id }).toString();
