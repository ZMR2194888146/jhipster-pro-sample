...
@Component
export default class DataPermissionRuleComponent extends Vue {
  ...
  public dataPermissionRules: IDataPermissionRule[] = [];
  ...
  public clickDataPermissionRuleId = null;
  public searchValue = '';
  ...
  public loadAll(): void {
    ...
    const paginationQuery = {
      listModelName: 'DataPermissionRule',
  ...
  public prepareRemove(instance: IDataPermissionRule): void {
  ...
  public removeById(removeId: number): void {
    this.dataPermissionRuleService()
      ...
      .then((res: AxiosResponse) => {
        const message = this.$t('lwjsApp.dataPermissionRule.deleted', { param: this.removeId }).toString();
  ...
  public editEntity(row: IDataPermissionRule): void {
    if (this.showInOther || this.editInModal) {
      this.dataPermissionRuleId = row.id;
  ...
  public updateModalCancel(e: any) {
    this.dataPermissionRuleId = null;
