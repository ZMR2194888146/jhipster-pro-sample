...
@Component
export default class AnnouncementRecordComponent extends Vue {
  ...
  public announcementRecords: IAnnouncementRecord[] = [];
  ...
  public clickAnnouncementRecordId = null;
  public searchValue = '';
  ...
  public loadAll(): void {
    ...
    const paginationQuery = {
      listModelName: 'AnnouncementRecord',
  ...
  public prepareRemove(instance: IAnnouncementRecord): void {
  ...
  public removeById(removeId: number): void {
    this.announcementRecordService()
      ...
      .then((res: AxiosResponse) => {
        const message = this.$t('lwjsApp.announcementRecord.deleted', { param: this.removeId }).toString();
  ...
  public editEntity(row: IAnnouncementRecord): void {
    if (this.showInOther || this.editInModal) {
      this.announcementRecordId = row.id;
  ...
  public updateModalCancel(e: any) {
    this.announcementRecordId = null;
