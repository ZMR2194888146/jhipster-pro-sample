  ...
  public save(): void {
    ...
    if (this.viewPermission.id) {
      this.viewPermissionService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.systemViewPermission.updated', { param: param.id }).toString();
      ...
      this.viewPermissionService()
        ...
        .then(param => {
          this.isSaving = false;
          const message = this.$t('lwjsApp.systemViewPermission.created', { param: param.id }).toString();
