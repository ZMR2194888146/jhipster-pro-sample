...
export default class UReportFileComponent extends Vue {
  ...
  public clickUReportFileId = null;
  public searchValue = '';
  ...
  public removeById(removeId: number): void {
    this.uReportFileService()
      ...
      .then((res: AxiosResponse) => {
        const message = this.$t('lwjsApp.reportUReportFile.deleted', { param: this.removeId }).toString();
