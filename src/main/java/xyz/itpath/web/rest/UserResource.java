...
import xyz.itpath.service.MailService;
...
import xyz.itpath.web.rest.errors.EmailAlreadyUsedException;
import xyz.itpath.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<List<AdminUserDTO>> getAllUsers(Pageable pageable) {
        ...
        final IPage<AdminUserDTO> page = userService.getAllManagedUsers(PageableUtils.toPage(pageable));
