...
/**
 * Criteria class for the {@link xyz.itpath.system.domain.SiteConfig} entity. This class is used
 * in {@link xyz.itpath.system.web.rest.SiteConfigResource} to receive all the possible filtering options from
...
public class SiteConfigCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, remark, fieldName, fieldValue, fieldType, createdBy, createdDate, lastModifiedBy, lastModifiedDate);
    }
