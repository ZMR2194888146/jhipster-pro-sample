...
import xyz.itpath.security.annotation.PermissionDefine;
...
public class ApiPermissionService extends BaseServiceImpl<ApiPermissionRepository, ApiPermission> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        xyz.itpath.domain.ApiPermission.class.getName() + ".parent",
        xyz.itpath.domain.ApiPermission.class.getName() + ".children",
        xyz.itpath.domain.Authority.class.getName() + ".apiPermissions"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(xyz.itpath.domain.ApiPermission.class.getName() + ".children")).clear();
    }
