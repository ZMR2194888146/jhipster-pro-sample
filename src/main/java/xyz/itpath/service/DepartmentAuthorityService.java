...
public class DepartmentAuthorityService extends BaseServiceImpl<DepartmentAuthorityRepository, DepartmentAuthority> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        xyz.itpath.domain.User.class.getName() + ".departmentAuthority",
        xyz.itpath.domain.ApiPermission.class.getName() + ".departmentAuthority",
        xyz.itpath.domain.ViewPermission.class.getName() + ".departmentAuthority",
        xyz.itpath.domain.Department.class.getName() + ".departmentAuthorities"
    );
