...
/**
 * Criteria class for the {@link xyz.itpath.domain.SysFillRule} entity. This class is used
 * in {@link xyz.itpath.web.rest.SysFillRuleResource} to receive all the possible filtering options from
...
public class SysFillRuleCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, code, implClass, params);
    }
