package xyz.itpath.service.criteria;
...
/**
 * Criteria class for the {@link xyz.itpath.domain.Department} entity. This class is used
 * in {@link xyz.itpath.web.rest.DepartmentResource} to receive all the possible filtering options from
...
public class DepartmentCriteria implements Serializable, Criteria {
    ...
    private LongFilter departmentAuthoritiesId;

    private StringFilter departmentAuthoritiesName;
    ...
    public DepartmentCriteria(DepartmentCriteria other) {
        ...
        this.departmentAuthoritiesId = other.departmentAuthoritiesId == null ? null : other.departmentAuthoritiesId.copy();
        this.departmentAuthoritiesName = other.departmentAuthoritiesName == null ? null : other.departmentAuthoritiesName.copy();
    }
    ...
    public LongFilter getDepartmentAuthoritiesId() {
        return departmentAuthoritiesId;
    }

    public LongFilter departmentAuthoritiesId() {
        if (departmentAuthoritiesId == null) {
            departmentAuthoritiesId = new LongFilter();
        }
        return departmentAuthoritiesId;
    }

    public void setDepartmentAuthoritiesId(LongFilter departmentAuthoritiesId) {
        this.departmentAuthoritiesId = departmentAuthoritiesId;
    }

    public StringFilter getDepartmentAuthoritiesName() {
        return departmentAuthoritiesName;
    }

    public StringFilter departmentAuthoritiesName() {
        if (departmentAuthoritiesName == null) {
            departmentAuthoritiesName = new StringFilter();
        }
        return departmentAuthoritiesName;
    }

    public void setDepartmentAuthoritiesName(StringFilter departmentAuthoritiesName) {
        this.departmentAuthoritiesName = departmentAuthoritiesName;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(departmentAuthoritiesId, that.departmentAuthoritiesId) &&
            Objects.equals(departmentAuthoritiesName, that.departmentAuthoritiesName)
        );
    }
    ...
    public int hashCode() {
        return Objects.hash(
            ...
            usersId,
            usersFirstName,
            departmentAuthoritiesId,
            departmentAuthoritiesName
        );
    }
    ...
    public String toString() {
        return "DepartmentCriteria{" +
                ...
                (departmentAuthoritiesId != null ? "departmentAuthoritiesId=" + departmentAuthoritiesId + ", " : "") +
                (departmentAuthoritiesName != null ? "departmentAuthoritiesName=" + departmentAuthoritiesName + ", " : "") +
