...
public class ResourceCategoryService extends BaseServiceImpl<ResourceCategoryRepository, ResourceCategory> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        xyz.itpath.domain.UploadFile.class.getName() + ".category",
        xyz.itpath.domain.ResourceCategory.class.getName() + ".parent",
        xyz.itpath.domain.UploadImage.class.getName() + ".category",
        xyz.itpath.domain.ResourceCategory.class.getName() + ".children"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(xyz.itpath.domain.ResourceCategory.class.getName() + ".children")).clear();
    }
