...
public class RegionCodeService extends BaseServiceImpl<RegionCodeRepository, RegionCode> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        xyz.itpath.domain.RegionCode.class.getName() + ".parent",
        xyz.itpath.domain.RegionCode.class.getName() + ".children"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(xyz.itpath.domain.RegionCode.class.getName() + ".children")).clear();
    }
