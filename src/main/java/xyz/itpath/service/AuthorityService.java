...
public class AuthorityService extends BaseServiceImpl<AuthorityRepository, Authority> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        xyz.itpath.domain.Authority.class.getName() + ".parent",
        xyz.itpath.domain.Authority.class.getName() + ".children",
        xyz.itpath.domain.ApiPermission.class.getName() + ".authorities",
        xyz.itpath.domain.ViewPermission.class.getName() + ".authorities"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(xyz.itpath.domain.Authority.class.getName() + ".children")).clear();
    }
