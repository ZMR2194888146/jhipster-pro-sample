...
public class ViewPermissionService extends BaseServiceImpl<ViewPermissionRepository, ViewPermission> {
    ...
    private final List<String> relationCacheNames = Arrays.asList(
        xyz.itpath.domain.ViewPermission.class.getName() + ".parent",
        xyz.itpath.domain.ViewPermission.class.getName() + ".children",
        xyz.itpath.domain.Authority.class.getName() + ".viewPermissions"
    );
    ...
    private void clearChildrenCache() {
        Objects.requireNonNull(cacheManager.getCache(xyz.itpath.domain.ViewPermission.class.getName() + ".children")).clear();
    }
