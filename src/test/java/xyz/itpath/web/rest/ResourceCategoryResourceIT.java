...
import xyz.itpath.repository.ResourceCategoryRepository;
import xyz.itpath.service.ResourceCategoryQueryService;
import xyz.itpath.service.criteria.ResourceCategoryCriteria;
import xyz.itpath.service.dto.ResourceCategoryDTO;
import xyz.itpath.service.mapper.ResourceCategoryMapper;
...
@WithMockUser
class ResourceCategoryResourceIT {
    ...
    void partialUpdateResourceCategoryWithPatch() throws Exception {
        ...
        partialUpdatedResourceCategory.code(UPDATED_CODE).sort(UPDATED_SORT);
