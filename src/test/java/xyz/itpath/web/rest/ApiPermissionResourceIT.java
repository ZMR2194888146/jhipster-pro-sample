...
import xyz.itpath.domain.enumeration.ApiPermissionType;
import xyz.itpath.repository.ApiPermissionRepository;
import xyz.itpath.service.ApiPermissionQueryService;
import xyz.itpath.service.criteria.ApiPermissionCriteria;
import xyz.itpath.service.dto.ApiPermissionDTO;
import xyz.itpath.service.mapper.ApiPermissionMapper;
...
class ApiPermissionResourceIT {
    ...
    @Test
    @Transactional
    void getAllApiPermissionsByStatusIsNotEqualToSomething() throws Exception {
        // Initialize the database
        apiPermissionRepository.insert(apiPermission);

        // Get all the apiPermissionList where status not equals to DEFAULT_STATUS
        defaultApiPermissionShouldNotBeFound("status.notEquals=" + DEFAULT_STATUS);

        // Get all the apiPermissionList where status not equals to UPDATED_STATUS
        defaultApiPermissionShouldBeFound("status.notEquals=" + UPDATED_STATUS);
    }
