...
import xyz.itpath.domain.ApiPermission;
...
import xyz.itpath.service.AuthorityQueryService;
import xyz.itpath.service.AuthorityService;
import xyz.itpath.service.criteria.AuthorityCriteria;
import xyz.itpath.service.dto.AuthorityDTO;
import xyz.itpath.service.mapper.AuthorityMapper;
...
class AuthorityResourceIT {
    ...
    void getAllAuthoritiesWithEagerRelationshipsIsEnabled() throws Exception {
        when(authorityServiceMock.findAllWithEagerRelationships(any())).thenReturn(new Page().setRecords(new ArrayList<>()));
    ...
    @Test
    @Transactional
    void getAllAuthoritiesByNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        authorityRepository.insert(authority);
    ...
    @Test
    @Transactional
    void getAllAuthoritiesByCodeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        authorityRepository.insert(authority);
    ...
    @Test
    @Transactional
    void getAllAuthoritiesByInfoIsNotEqualToSomething() throws Exception {
        // Initialize the database
        authorityRepository.insert(authority);
    ...
    @Test
    @Transactional
    void getAllAuthoritiesByOrderIsNotEqualToSomething() throws Exception {
        // Initialize the database
        authorityRepository.insert(authority);
    ...
    @Test
    @Transactional
    void getAllAuthoritiesByDisplayIsNotEqualToSomething() throws Exception {
        // Initialize the database
        authorityRepository.insert(authority);
    ...
    @Test
    @Transactional
    void putNewAuthority() throws Exception {
        // Initialize the database
        authorityRepository.insert(authority);
    ...
    void partialUpdateAuthorityWithPatch() throws Exception {
        ...
        partialUpdatedAuthority.name(UPDATED_NAME).code(UPDATED_CODE).display(UPDATED_DISPLAY);
