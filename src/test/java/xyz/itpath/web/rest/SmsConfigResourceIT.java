...
import xyz.itpath.domain.enumeration.SmsProvider;
import xyz.itpath.repository.SmsConfigRepository;
import xyz.itpath.service.SmsConfigQueryService;
import xyz.itpath.service.criteria.SmsConfigCriteria;
...
class SmsConfigResourceIT {
    ...
    void partialUpdateSmsConfigWithPatch() throws Exception {
        ...
        partialUpdatedSmsConfig.enabled(UPDATED_ENABLED);
