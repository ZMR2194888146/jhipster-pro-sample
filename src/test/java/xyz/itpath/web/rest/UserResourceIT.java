...
class UserResourceIT {
    ...
    void createUser() throws Exception {
        ...
        managedUserVM.setAuthorities(authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singletonList).get());
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setCreatedBy(DEFAULT_ID);
        userDTO.setLastModifiedBy(DEFAULT_ID);
        userDTO.setAuthorities(authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singletonList).get());
