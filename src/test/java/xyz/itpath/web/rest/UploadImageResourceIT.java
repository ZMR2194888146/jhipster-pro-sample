...
import xyz.itpath.domain.ResourceCategory;
import xyz.itpath.domain.UploadImage;
import xyz.itpath.domain.User;
import xyz.itpath.repository.UploadImageRepository;
import xyz.itpath.service.UploadImageQueryService;
import xyz.itpath.service.criteria.UploadImageCriteria;
import xyz.itpath.service.dto.UploadImageDTO;
import xyz.itpath.service.mapper.UploadImageMapper;
...
class UploadImageResourceIT {
    ...
    @Test
    @Transactional
    void getAllUploadImagesByUserIsEqualToSomething() throws Exception {
        // Initialize the database
        uploadImageRepository.insert(uploadImage);
