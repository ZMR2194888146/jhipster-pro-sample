...
import xyz.itpath.domain.enumeration.OssProvider;
import xyz.itpath.repository.OssConfigRepository;
import xyz.itpath.service.OssConfigQueryService;
import xyz.itpath.service.criteria.OssConfigCriteria;
import xyz.itpath.service.dto.OssConfigDTO;
import xyz.itpath.service.mapper.OssConfigMapper;
...
class OssConfigResourceIT {
    ...
    void partialUpdateOssConfigWithPatch() throws Exception {
        ...
        partialUpdatedOssConfig.ossCode(UPDATED_OSS_CODE).region(UPDATED_REGION).remark(UPDATED_REMARK).enabled(UPDATED_ENABLED);
