package xyz.itpath.config.timezone;
...
import xyz.itpath.repository.timezone.DateTimeWrapper;
import xyz.itpath.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    public void storeInstantWithZoneIdConfigShouldBeStoredOnGMTTimeZone() {
        dateTimeWrapperRepository.insert(dateTimeWrapper);
