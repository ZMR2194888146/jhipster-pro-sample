...
import ApiPermissionDetailComponent from '@/entities/system/api-permission/api-permission-details.vue';
import ApiPermissionClass from '@/entities/system/api-permission/api-permission-details.component';
