...
import UploadFileComponent from '@/entities/files/upload-file/upload-file.vue';
import UploadFileClass from '@/entities/files/upload-file/upload-file.component';
