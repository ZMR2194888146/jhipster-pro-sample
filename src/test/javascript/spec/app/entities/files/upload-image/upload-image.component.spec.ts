...
import UploadImageComponent from '@/entities/files/upload-image/upload-image.vue';
import UploadImageClass from '@/entities/files/upload-image/upload-image.component';
